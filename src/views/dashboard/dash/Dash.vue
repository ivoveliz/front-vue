...
import AnalyticsCongratulation from './DashCongratulation.vue'
import AnalyticsAvgSessions from './DashAvgSessions.vue'
import AnalyticsSupportTracker from './DashSupportTracker.vue'
import AnalyticsTimeline from './DashTimeline.vue'
import AnalyticsSalesRadarChart from './DashSalesRadarChart.vue'
import AnalyticsAppDesign from './DashAppDesign.vue'
